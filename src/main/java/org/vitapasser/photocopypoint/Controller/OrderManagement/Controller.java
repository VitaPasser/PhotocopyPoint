...
public class Controller {
    ...
    protected void onGetMoreNotMadeOrdersButtonClick(ActionEvent event) throws IOException {
        ...
        Scene scene = new Scene(FXMLLoader.load());
        org.vitapasser.photocopypoint.Controller.TakeOrdersController controller = FXMLLoader.getController();
        controller.putData(register);
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(scene);
        stage.show();
    ...
    protected void onGetMoreInfoOrderButtonClick(ActionEvent event) throws IOException {
        ...
        controller.putData(register, listOfTicketsTableView.getSelectionModel().getSelectedItem().getOrderId());
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(scene);
        stage.show();
    }
